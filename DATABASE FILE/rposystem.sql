...
INSERT INTO `rpos_orders` (`order_id`, `order_code`, `customer_id`, `customer_name`, `prod_id`, `prod_name`, `prod_price`, `prod_qty`, `table_id`, `order_status`, `created_at`) VALUES
('019661e097', 'AEHM-0653', '06549ea58afd', 'Ana J. Browne', 'bd200ef837', 'Turkish Coffee', '8', '1', '1', 'Paid', '2022-09-03 13:26:00.389027'),
('49c1bd8086', 'IUSP-9453', 'fe6bb69bdd29', 'Brian S. Boucher', 'd57cd89073', 'Country Fried Steak', '10', '1', '2', 'Paid', '2022-09-03 11:50:40.812796'),
('514ada5047', 'OTEV-8532', '3859d26cd9a5', 'Louise R. Holloman', '0c4b5c0604', 'Spaghetti Bolognese', '15', '1', '1','Paid', '2022-09-03 13:13:39.042869'),
('6466fd5ee5', 'COXP-6018', '7c8f2100d552', 'Melody E. Hance', '31dfcc94cf', 'Buffalo Wings', '11', '2', '2','Paid', '2022-09-03 12:17:44.680896'),
('80ab270866', 'JFMB-0731', '35135b319ce3', 'Christine Moore', '97972e8d63', 'Irish Coffee', '11', '1', '1','Paid', '2022-09-04 16:37:03.716697'),
('8815e7edfc', 'QOEH-8613', '29c759d624f9', 'Trina L. Crowder', '2b976e49a0', 'Cheeseburger', '3', '3', '2','Paid', '2022-09-03 12:02:32.985451'),
('a27f1d87be', 'EJKA-4501', '35135b319ce3', 'Christine Moore', 'ec18c5a4f0', 'Corn Dogs', '4', '2', '1','Paid', '2022-09-04 16:31:54.581984'),
('a74337db7e', 'ZPXD-6951', 'e711dcc579d9', 'Julie R. Martin', 'a5931158fe', 'Pulled Pork', '8', '2', '2','Paid', '2022-09-03 13:12:47.079248'),
('af52d0022d', 'FNAB-9142', '35135b319ce3', 'Christine Moore', '2fdec9bdfb', 'Jambalaya', '9', '2', '1', 'Paid', '2022-09-04 16:32:14.949302'),
('c051fc38eb', 'ONSY-2465', '57b7541814ed', 'Howard W. Anderson', '826e6f687f', 'Margherita Pizza', '12', '1', '2','Paid', '2022-09-03 08:35:50.570496'),
('fc79a55455', 'INHG-0875', '9c7fcc067bda', 'Delbert G. Campbell', '3adfdee116', 'Enchiladas', '10', '1', '1','Paid', '2022-09-04 16:35:22.539542');
...
-- --------------------------------------------------------
--
-- Table structure for table `rpos_tables`
--
CREATE TABLE `rpos_tables` (
    table_id INT PRIMARY KEY AUTO_INCREMENT,
    status ENUM('Available', 'Reserved') DEFAULT 'Available'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

---- Dumping data for table `rpos_tables`
INSERT INTO `rpos_tables` (`status`) VALUES
('Available'),
('Available');
...
--
-- Table structure for table `rpos_reservations`
--
CREATE TABLE `rpos_reservations` (
...
ALTER TABLE `rpos_orders`
  ...
  ADD CONSTRAINT `OrderTable` FOREIGN KEY (`table_id`) REFERENCES `rpos_tables`(`table_id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `rpos_reservations`
    ADD CONSTRAINT `ReserveCustomer` FOREIGN KEY (`customer_id`) REFERENCES `rpos_customers`(`customer_id`) ON DELETE CASCADE ON UPDATE CASCADE,
    ADD CONSTRAINT `ReserveTable` FOREIGN KEY (`table_id`) REFERENCES `rpos_tables`(`table_id`) ON DELETE CASCADE ON UPDATE CASCADE;
