...
if (isset($_POST['make'])) {
  ...
  if (empty($_POST["order_code"]) || empty($_GET['prod_price']) || empty($_POST['order_type'])) {
    $err = "Blank Values Not Accepted";
  }
  else if ( !isset($_POST["prod_qty"]) || $_POST["prod_qty"] === "" || $_POST["prod_qty"] <= 0) {
    ...
    if ($order_type == "DineIn") {
      ...
      if ($result->num_rows > 0 ) {
        ...
        $reservation_message = "No Reservation Found. Please Reserve First. You Need Admin To Reserve A Table For You.";
      }
    }
                ...
                <div class="form-row">
                  <div class="col-md-4">
                    <label>Customer Name</label>
                      <input type="text" class="form-control" readonly value="<?php echo htmlspecialchars($_SESSION['customer_name']); ?>">
                  </div>

                <div class="col-md-4">
                  <label>Customer ID</label>
                    <input type="text" class="form-control" readonly value="<?php echo htmlspecialchars($_SESSION['customer_id']); ?>">
                </div>
